...
class TweetProcessor():
   def __init__(self, handle_negation=False):
      ...
      # Stop words
      self.custom_stopwords = {'a', 'about', 'after', 'again', 'get', 'all', 'am', 'an', 'and', 'any', 'are', 'around', 'as', 'at', 'be', 'because', 'been', 'before', 'being', 'between', 'both', 'by', 'can', 'd', 'did', 'do', 'does', 'doing', 'during', 'each', 'for', 'from', 'had', 'has', 'have', 'having', 'he', 'her', 'here', 'hers', 'herself', 'him', 'himself', 'his', 'how', 'got', 'i', 'if', 'in', 'into', 'is', 'it', "it's", 'its', 'itself', 'just', 'll', 'm', 'ma', 'may', 'me', 'my', 'myself', 'now', 'o', 'of', 'once', 'only', 'or', 'other', 'our', 'ours', 'ourselves', 'own', 're', 's', 'rt', 'same', 'she', "she's", 'should', "should've", 'so', 'some', 'such', 't', 'than', 'that', "that'll", 'the', 'their', 'theirs', 'them', 'themselves', 'then', 'there', 'these', 'they', 'this', 'those', 'through', 'to', 'under', 'until', 've', 'very', 'was', 'w', 'we', 'were', 'what', 'when', 'where', 'which', 'while', 'who', 'whom', 'why', 'will', 'with', 'you', "you'd", "you'll", "you're", 'your', 'yours', 'yourself', 'yourselves', "'s", "'ve", "'ll", "'m'"}
